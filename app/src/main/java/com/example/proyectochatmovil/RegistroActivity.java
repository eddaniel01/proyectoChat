        ...
        registrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(txt_userName) || TextUtils.isEmpty(txt_correo) || TextUtils.isEmpty(txt_contrasena)){
                    ...
                    Toast.makeText(RegistroActivity.this, "La contraseña debe contener mas de 6 digitos.", Toast.LENGTH_SHORT).show();
                }else {
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(RegistroActivity.this, "Error al registrar con este Email o password", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
